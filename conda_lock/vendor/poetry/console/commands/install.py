...
"""
    ...
    def handle(self):
        from conda_lock.vendor.poetry_core.masonry.utils.module import ModuleOrPackageNotFound
        from conda_lock.vendor.poetry.masonry.builders import EditableBuilder
