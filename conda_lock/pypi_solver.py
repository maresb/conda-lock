...
from conda_lock.vendor.poetry.installation.chooser import Chooser
from conda_lock.vendor.poetry.installation.operations.uninstall import Uninstall
...
from conda_lock.vendor.poetry_core.packages import (
    Dependency,
    Package,
    ProjectPackage,
    URLDependency,
