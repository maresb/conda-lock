...
- ``solver.repodata_cache``: URL normalization, cache path
  derivation, record identity checks, mamba 2.1.1-2.5 stub-record
...
def update_specs_for_arch(
    ...
    # generated against a corrupt mamba 2.1.1-2.5 cache stays corrupt
    ...
    if heal_report.healed:
        logger.warning(
            ...
            "mamba/micromamba 2.1.1-2.5 (see conda/conda-lock#896 / "
    ...
    if heal_report.ambiguous:
        ...
        logger.warning(
            ...
            "mamba/micromamba 2.1.1-2.5 cache (see "
